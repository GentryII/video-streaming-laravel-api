...
@stop
@section('content')
        {!! Form::open(['action' => ['UsersController@update', $user->id], 'method' => 'PATCH', 'files' => true, 'style' => 'margin-left: 100px; margin-right: 100px;']) !!}
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="form-group">
            <label style="margin-top: 30px">New User Name</label>
